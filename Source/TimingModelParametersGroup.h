...
#pragma region Base Model Parameters
    ...
    {
    public:
        ModelParameters::ModelParameters(int numberOfPlayers) : numberOfPlayers(numberOfPlayers) {};
        ~ModelParameters() {};
    ...
    public:
        ...
        public:
            ModelParameterIndexGetter(ModelParameters &paramGroup, std::string paramName) : paramGroup(paramGroup), paramName(paramName) {}

            ModelParameterIndexGetter(ModelParameters &paramGroup) : paramGroup(paramGroup) {}
